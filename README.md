...
* Quels sont les 10 pays avec la plus faible espérance de vie sur cette période?
* Quelle est l'évolution de l'espérance de vie mondiale entre 2000 et 2015?
## Nettoyage des données
* gestion des valeurs manquantes et valeurs aberrantes
* autres étapes nécessaires
* aggrégation sur le nombre de catastrophes, total de morts
* aggrégation sur le nombre de conflits
